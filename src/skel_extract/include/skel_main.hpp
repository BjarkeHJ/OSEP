#ifndef SKEL_MAIN_HPP_
#define SKEL_MAIN_HPP_
...
private:
    ...
    int drosa_iter = 4; //Number of drosa iterations
    int dcrosa_iter = 3;
    ...
    double gnd_th = 20; // Threshold for ground vertices removal (assumption of starting in the sky...)
